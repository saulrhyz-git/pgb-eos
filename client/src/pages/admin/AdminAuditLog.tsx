  ...
  if (forbidden) {
    return (
      <div className="flex flex-col items-center gap-3 rounded-lg border border-slate-200 bg-white p-12 text-center shadow-sm">
        ...
        <h2 className="text-lg font-semibold text-slate-700">Audit Log access required</h2>
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h2 className="mb-1 flex items-center gap-2 text-xl font-bold text-slate-800">
            <ScrollText className="h-5 w-5 text-brand-600" /> Audit Log
          </h2>
          <p className="text-sm text-slate-500">A history of who changed what, and when.</p>
        </div>
      </div>
                ...
                <Fragment key={entry.id}>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="font-medium text-slate-800">{entry.userName || "(unknown user)"}</div>
                  ...
                  {expandedId === entry.id && entry.metadata && (
                    <tr>
                      <td colSpan={5} className="bg-slate-50 px-4 py-3">
                        <pre className="max-w-full overflow-x-auto whitespace-pre-wrap break-words text-xs text-slate-600">
